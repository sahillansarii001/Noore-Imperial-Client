        ...
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-4">
              <span className="font-poppins text-xs uppercase text-grey tracking-widest">Showing {products.length} creations</span>
              ...
              <div className="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
                ...
                <button 
                  className="lg:hidden flex items-center gap-2 text-gold font-montserrat text-[10px] uppercase tracking-widest border border-gold/30 px-3.5 py-2 hover:bg-gold hover:text-black transition-colors"
